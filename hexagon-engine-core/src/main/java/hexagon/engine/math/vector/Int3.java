...
/**
 * Record that represents a 3D int vector with components [a, b, c]
 * 
 * @author Nico
 */
public record Int3(int a, int b, int c) implements IntVector<Int3, Float3> {
	...
	/**
	 * Subtracts the vector [a, b, c] from this vector 
	 * 
	 * @param a First component of the vector
	 * @param b Second component of the vector
	 * @param c Third component of the vector
	 * 
	 * @return The difference between this vector and the vector [a, b, c]
	 */
	...
	/**
	 * Computes the dot product between this vector and the vector [a, b, c]
	 * 
	 * @param a First component of the vector
	 * @param b Second component of the vector
	 * @param c Third component of the vector
	 * 
	 * @return The dot product between this vector and the vector [a, b, c]
	 */
